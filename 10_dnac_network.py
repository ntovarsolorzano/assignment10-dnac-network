...
# This script is designed to interact with Cisco DNA Center API to manage network devices and their interfaces.
# It includes authentication, device listing, and interface retrieval functionalities.